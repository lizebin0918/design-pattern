...
public class EditingState extends AbstractState {
    ...
    public Result arraignment(Long activityId, ActivityStatus currentState) {
        boolean isSuccess = activityRepository.alterStatus(activityId, currentState, ActivityStatus.ARRAIGNMENT);
        return isSuccess ? Result.buildResult(Result.SUCCESS_CODE, "活动提审成功") : Result.buildErrorResult("活动状态变更失败");
    }
